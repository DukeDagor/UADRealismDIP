...
namespace TweaksAndFixes
{
    ...
    public class Config
    {
        ...
        internal static readonly FilePath _PredefinedDesignsDataFile = new FilePath(FilePath.DirType.ModsDir, "PredefinedDesigns/predefinedDesignsData.csv");
        internal static readonly FilePath _PredefinedDesignsFileDataFile = new FilePath(FilePath.DirType.ModsDir, "PredefinedDesigns/predefinedDesignsFiles.csv");
